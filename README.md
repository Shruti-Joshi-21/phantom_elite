...
| **Physics Layer** | Custom regularization (InVEST UCM formulation) |
| **Optimization** | Custom constrained-ranking engine |
| **Live Data** | Weather API, Geolocation |
| **Deployment** | Docker |
...
|---------|--------|----------|
| **Land Surface Temperature** | Landsat-8, ECOSTRESS | Baseline heat mapping |
| **Land Use / Land Cover** | Sentinel-2 | Feature extraction |
| **Atmospheric Variables** | ERA5, CPCB | Model features and validation |
